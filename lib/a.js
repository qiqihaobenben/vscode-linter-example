...
console.log("line:12&column:0", createHeading);
...
console.log("line:17&column:0", B);
new _Promise();
...
require("@babel/traverse").default(ast, {
  VariableDeclaration: function VariableDeclaration(path) {
    ...
    if (t.isIdentifier(tarNode.id) && t.isNumericLiteral(tarNode.init)) {
      console.log("line:27&column:6", 1);
      tarNode.id.name = "".concat(tarNode.id.name, ": number");
    }

    console.log("line:30&column:4", tarNode);
  }
});

var result = require("@babel/generator").default(ast, {});

console.log("line:36&column:0", result.code);